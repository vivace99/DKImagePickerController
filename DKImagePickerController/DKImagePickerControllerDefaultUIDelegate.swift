...
open class DKImagePickerControllerDefaultUIDelegate: NSObject, DKImagePickerControllerUIDelegate {
	...
	open func imagePickerControllerCreateCamera(_ imagePickerController: DKImagePickerController, didCancel: @escaping (() -> Void), didFinishCapturingImage: @escaping ((UIImage) -> Void), didFinishCapturingVideo: ((URL) -> Void)) -> UIViewController {
	...
	open func imagePickerController(_ imagePickerController: DKImagePickerController,
		...
		vc.navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .cancel,
		                                                      ...
		                                                      action: #selector(DKImagePickerController.myDismiss))
	}
