...
open class DKPopoverViewController: UIViewController {
    ...
    open class func dismissPopoverViewController() {
        ...
        for vc in window.rootViewController!.childViewControllers {
            if vc is DKPopoverViewController {
                (vc as! DKPopoverViewController).dismiss(animated: false)
            }
        }
    }
    ...
    fileprivate class DKPopoverView: UIView {
        ...
        func arrowImage() -> UIImage {
            ...
            arrowPath.move(to: CGPoint(x: arrowWidth/2, y: 0), transform: CGAffineTransform.identity)
    ...
    override open func loadView() {
        ...
        backgroundView.addTarget(self, action: #selector(DKPopoverViewController.myDismiss), for: .touchUpInside)
